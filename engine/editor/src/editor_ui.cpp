...
#include "editor/include/editor_imgui_opengl_renderer.h"
#include "editor/include/editor_imgui_vulkan_renderer.h"
#include "editor/include/editor_imgui_glfw_wsi.h"
...
namespace kpengine::editor
{
    ...
    bool EditorUI::Render()
    {
        ...
        GLuint texID = editor::global_editor_context.render_system_->GetRenderScene()->debug_id;
        ImVec2 size = ImVec2(360, 256); // size of the preview

        ImGui::Text("Normal Buffer");
        ImGui::Image((ImTextureID)(uintptr_t)texID, size);
        ImGui::EndChild();
