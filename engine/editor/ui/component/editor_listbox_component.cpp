#include "editor/ui/component/editor_listbox_component.h"
...
namespace kpengine::editor
{
    ...
    EditorListboxComponent::EditorListboxComponent(std::vector<const char *> list_items) : list_items_(list_items)
    {
    }
