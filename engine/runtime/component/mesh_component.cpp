...
namespace kpengine
{
    ...
    MeshComponent::MeshComponent(const std::string &mesh_realtive_path) : mesh_(std::make_shared<RenderMesh>(mesh_realtive_path))
    {
    }
