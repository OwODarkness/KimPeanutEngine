...
namespace kpengine::graphics
{
    inline VkFormat ConvertToVulkanTextureFormat(TextureFormat format)
    {
        ...
        case TextureFormat::TEXTURE_FORMAT_BGRA8_UNORM:
...
inline TextureFormat ConvertFromVulkanTextureFormat(VkFormat format)
{
    ...
    case VK_FORMAT_B8G8R8A8_UNORM:
        return TextureFormat::TEXTURE_FORMAT_BGRA8_UNORM;
    ...
    {
        // The Vulkan viewport translation uses a negative height to preserve
        // the common y-up clip-space orientation, so enum spellings map directly.
        switch (front_face)
        {
