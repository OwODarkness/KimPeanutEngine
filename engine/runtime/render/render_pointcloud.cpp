...
namespace kpengine
{
    RenderPointCloud::RenderPointCloud() : pointcloud_resource_(nullptr), name_("")
    {
    }

    RenderPointCloud::RenderPointCloud(const std::string &relative_path) : pointcloud_resource_(std::make_unique<RenderPointCloudResource>()), name_(relative_path)
    {
    }
