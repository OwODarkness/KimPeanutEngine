...
namespace kpengine{
    ...
    private:
        ...
        std::string ProcessTexture(aiMaterial* material, aiTextureType assip_texture_type);
        void ComputeTangent(aiMesh* mesh, const aiScene* scene, RenderMeshResource& mesh_resource);
