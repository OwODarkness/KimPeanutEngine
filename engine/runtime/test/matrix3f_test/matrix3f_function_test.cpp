...
TEST(Matrix3FunctionTest, Determinant)
{
    ...
    {
        kpengine::Matrix3f mat{3.f, 2.f, 1.f, 4.f, 5.f, 6.f, 7.f, 8.f, 9.f};
        EXPECT_FLOAT_EQ(mat.Determinant(), -6.f);
    }
}
...
TEST(Matrix3FunctionTest, Inverse)
{
    ...
    {
        kpengine::Matrix3f mat{4.f, 7.f, 2.f, 3.f, 6.f, 1.f, 2.f, 5.f, 3.f};
        kpengine::Matrix3f expect{1.f, -1.f, 1.f, -1.f, 2.f, -2.f, 1.f, -2.f, 3.f};
        EXPECT_EQ(mat.Inverse(), expect);
    }
...
TEST(Matrix3FunctionTest, Adjoint)
{
    ...
    {
        kpengine::Matrix3f mat{1.f, 2.f, 3.f, 0.f, 1.f, 4.f, 5.f, 6.f, 0.f};
        kpengine::Matrix3f expect{-24.f, 18.f, 5.f, 20.f, -15.f, -4.f, -5.f, 4.f, 1.f};
